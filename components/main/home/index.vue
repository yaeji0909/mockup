  ...
  <header class="relative flex items-center h-screen overflow-hidden">
    <main class="relative z-30 p-5 text-2xl mx-1 md:mx-8 xl:mx-80">
      ...
      <section class="buttons opacity-0 mt-14 gap-4 md:gap-10 text-white flex">
        ...
        <CommonButton
          class="a-btn"
          :text="$t('button.appStore')"
          :icon="true"
          @click="ClickBtn(APP_STORE_URL)"
        >
          <template #icon>
...
const MAIN_VIDEO =
  "https://naturemobility.s3.ap-northeast-2.amazonaws.com/video/main_video.mp4";
const GOOGLE_PLAY_URL =
  "https://play.google.com/store/apps/details?id=kr.co.zzimcar.userandroid&hl=ko";
const APP_STORE_URL =
  "https://play.google.com/store/apps/details?id=kr.co.zzimcar.userandroid&hl=ko";
const GOOGLE_PLAY_ICON =
  "https://naturemobility.s3.ap-northeast-2.amazonaws.com/image/playstore.svg";
const APP_STORE_ICON =
  "https://naturemobility.s3.ap-northeast-2.amazonaws.com/image/appstore.svg";
const APP_STORE_ICON_BK =
  "https://naturemobility.s3.ap-northeast-2.amazonaws.com/image/appstore-black.svg";
