<template>
  <video class="absolute w-screen" muted autoplay loop>
    <source src="https://naturemobility.s3.ap-northeast-2.amazonaws.com/video/main_video.mp4" type="video/mp4" />
  </video>
  <main class="relative">
    <section class="title">
    ...
    <section class="buttons mt-14 text-white">
      <button>버튼1</button>
      <button>버튼2</button>
    </section>
  </main>
